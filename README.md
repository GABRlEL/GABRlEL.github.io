...
[Can't put down the CONF — a Wii SYSCONF IPL.SADR editor, sponsored by ChatGPT 5 Thinking](https://gabrlel.github.io/region.html)

[Godviewer — rksys.dat Viewer (based on the private Godtool)](https://gabrlel.github.io/godviewer.html)

[Godviewer — RKP License Viewer (derived off of Godviewer — rksys.dat Viewer)](https://gabrlel.github.io/godviewerrkp.html)
...
[WebPort Beta 2 - wstrt port & mkw-sp port derivate](https://gabrlel.github.io/port/webport-beta2.html) [license: GPL 2.0, web-based derivate from wstrt port](https://gabrlel.github.io/port/gpl-2.0.txt), [license: MIT, web-based derivate from mkw-sp port](https://gabrlel.github.io/port/license-mkw-sp.txt)
